...
public class FirstPersonController : MonoBehaviour {
	...
	void Update () {
        ...
        /*
        // Rotation
        rotLeftRight = Input.GetAxis("Mouse X") * lookSensitivity;
        verticalRotation = Input.GetAxis("Mouse Y") * lookSensitivity;

        rotLeftRight = Mathf.Lerp(rotLeftRight, rotX, snappiness * Time.deltaTime);
        verticalRotation = Mathf.Lerp(verticalRotation, rotY, snappiness * Time.deltaTime);
